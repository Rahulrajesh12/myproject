        ...
        <div className={`bg-white`}>
            <div className='flex pl-10 py-5 md:justify-between text-white xl:px-28 lg:py-14 flex-wrap bg-[#660066] rounded-md mx-[14px] lg:mx-[58px] my-3 items-center '>
                <div className=' xl:text-left lg:text-base text-left text-xs font-semibold'>
                    <ul className='lg:gap-x-16 lg:gap-y-4 gap-2 grid lg:grid-cols-3 grid-cols-1 capitalize'>
                        ...
                        <li className='hover:scale-105'><Link href={'/branches/hyderabad-rental-car'}>Car rental serrvices in Hyderabad</Link></li>
                        <li className='hover:scale-105'><Link href={'/branches/self-drive-cars-kukatpally'}>Car rental serrvices in Kukatpally</Link></li>
                        <li className='hover:scale-105'><Link href={'/branches/self-drive-cars-lbnagar-kothapet'}>Car rental serrvices in LB Nagar</Link></li>
                        <li className='hover:scale-105'><Link href={'/branches/self-drive-cars-madhapur.'}>Car rental serrvices in Madhapur</Link></li>
                        ...
                        <li className='hover:scale-105'><Link href={'/branches/self-drive-cars-bengaluru'}>Car rental serrvices in Bangalore</Link></li>
                        <li className='hover:scale-105'><Link href={'/branches/self-drive-cars-warangal'}>Car rental serrvices in Warangal</Link></li>
                        <li className='hover:scale-105'><Link href={'/branches/self-drive-cars-uppal-medipally.js'}>Car rental serrvices in Uppal Medipally</Link></li>
